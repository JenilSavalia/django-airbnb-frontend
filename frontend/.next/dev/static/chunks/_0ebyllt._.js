...
_s(Categories, "9swTrTgHUzNKhTqVHV4fM2fC1Hg=", false, function() {
    return [
...
const FavoriteButton = ({ id, is_favorite, markFavorite })=>{
    const toggleFavorite = async (e)=>{
        e.stopPropagation();
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$apiService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/api/properties/${id}/toggle_favorite/`, {});
        markFavorite(response.is_favorite);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        onClick: toggleFavorite,
        className: `absolute top-2 right-2 ${is_favorite ? 'text-red-600' : 'text-white'} hover:text-red-800`,
...
const PropertyList = ({ landlord_id, favorites })=>{
    ...
    const category = searchModal.query.catregory;
    ...
    const getProperties = async ()=>{
        ...
        if (landlord_id) {
            ...
            if (checkinDate) {
                urlQuery += '&checkin=' + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(checkinDate, 'yyyy-MM-dd');
            }
            if (checkoutDate) {
                urlQuery += '&checkout=' + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(checkoutDate, 'yyyy-MM-dd');
            }
            if (urlQuery.length) {
        ...
        const tmpProperties = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$apiService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(url);
        setProperties(tmpProperties.data.map((property)=>{
...
_s(PropertyList, "oQTTMeRUTU9h0v9ZHzQ6Ui+jICA=", false, function() {
    return [
...
//# sourceMappingURL=_0ebyllt._.js.map